...
1. Download the latest **KwikSap-v1.0.0.apk** from the **Releases** page.
2. Enable **Install from Unknown Sources** if prompted.
3. Install the APK on your Android device.
4. Grant microphone permission when launching the app.
5. Start communicating with KwikSap.
...
KwikSap is developed with accessibility and privacy in mind. Audio is processed solely for speech recognition and AI-assisted communication features within the application. User conversations are not intentionally stored or shared without user action.
